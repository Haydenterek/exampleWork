...
The following README is from the University of Pittsburgh CS 1501 class from John Ramirez. The purpose of this README and following code are only to showcase work done publicly to those that may need to view. There is no claim of ownership other than the code written by myself and the repository associated. This assignment should not be used for anything other than research purposes. The contents of the README below outline what was given to us for use during our time in the class.
